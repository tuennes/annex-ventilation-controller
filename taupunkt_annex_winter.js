////////////// TAUPI ANNEX WINTER @ Shelly Plug S Plus //////////////
// Dedicated winter-mode dew-point ventilation controller.
// This script only runs the winter logic and does not use the Shelly app switch.
...
var dewpoint_on_buffer_c = 2.0;
var dewpoint_off_buffer_c = 1.0;
var ble_debug = true;
...
function updateDeviceNameForApp() {
  ...
  var label = "Annex Winter I:" + inTemp + "°C/" + inHum + "% A:" + outTemp + "°C/" + outHum + "%";
...
function evaluateControl() {
  ...
  if (taupunkt_aussen <= taupunkt_innen - dewpoint_on_buffer_c) {
    should_run = true;
    reason = "Winter mode: outdoor dew point is at least 2 °C lower than indoor";
  } else if (taupunkt_aussen >= taupunkt_innen - dewpoint_off_buffer_c) {
    should_run = false;
    reason = "Winter mode: outdoor dew point is less than 1 °C below indoor";
  }
